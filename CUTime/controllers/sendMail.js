/*
    ...
    Reference : (Google API) https://www.youtube.com/watch?v=npsi7ZkjvQo for sending activation/reset pw email
*/
    ...
    const mailOptions = {
        ...
        html: `
            ...
            <p>Congratulations! You're almost set to start using CUTime.
                Just click the button below to ${msg}.
            </p>
            
            <tr>
                <td align="center"><a href=${url} style="background: cyan; text-decoration: none; color: white; padding: 10px 20px; margin: 10px 0; display: inline-block;">${msg}</a></td>
            </tr>
